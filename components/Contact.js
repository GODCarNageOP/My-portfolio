...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_dh1q2v6', 'template_3dsy6sq', form.current, 'oiyK82ekyOKggogpg')
      .then((result) => {
    ...
    return (
        ...
        <div class="form-group">
          ...
          <input type="email" class="form-control" id="exampleInputPassword1" placeholder="Email" name="user_email"/>
          <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>
        </div>
        <div class="form-group form-check">
          <label class="form-check-label" for="exampleCheck1">Message</label>
          <textarea name="message" />
          <small id="emailHelp" class="form-text text-muted">We will get in touch with you very soon.</small>
        </div>
